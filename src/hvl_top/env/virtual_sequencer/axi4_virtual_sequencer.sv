...
function axi4_virtual_sequencer::new(string name = "axi4_virtual_sequencer",
  ...
  axi4_master_write_seqr_h = new[NO_OF_MASTERS];
  axi4_master_read_seqr_h  = new[NO_OF_MASTERS];
  axi4_slave_write_seqr_h  = new[NO_OF_SLAVES];
  axi4_slave_read_seqr_h   = new[NO_OF_SLAVES];
endfunction : new
