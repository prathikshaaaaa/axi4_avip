...
function void axi4_base_test:: setup_axi4_env_cfg();
  ...
  axi4_env_cfg_h.allocate_configs();
...
function void axi4_base_test::setup_axi4_master_agent_cfg();
  ...
  foreach (axi4_env_cfg_h.axi4_master_agent_cfg_h[m]) begin
    axi4_env_cfg_h.axi4_master_agent_cfg_h[m].is_active = UVM_ACTIVE;
    axi4_env_cfg_h.axi4_master_agent_cfg_h[m].has_coverage = 1;
    axi4_env_cfg_h.axi4_master_agent_cfg_h[m].qos_mode_type = QOS_MODE_DISABLE;

    local_min = 0;

    for (int s = 0; s < NO_OF_SLAVES; s++) begin
      axi4_env_cfg_h.axi4_master_agent_cfg_h[m]
        .master_min_addr_range(s, local_min);

      local_max = local_min + (2**SLAVE_MEMORY_SIZE) - 1;

      axi4_env_cfg_h.axi4_master_agent_cfg_h[m]
        .master_max_addr_range(s, local_max);

      local_min = local_max + SLAVE_MEMORY_GAP;
    end
  end
endfunction: setup_axi4_master_agent_cfg
...
function void axi4_base_test::setup_axi4_slave_agent_cfg();
  foreach (axi4_env_cfg_h.axi4_slave_agent_cfg_h[s]) begin
    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].slave_id = s;

    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].min_address =
      axi4_env_cfg_h.axi4_master_agent_cfg_h[0]
        .master_min_addr_range_array[s];

    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].max_address =
      axi4_env_cfg_h.axi4_master_agent_cfg_h[0]
        .master_max_addr_range_array[s];

    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].maximum_transactions = 3;
    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].read_data_mode = SLAVE_MEM_MODE;
    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].slave_response_mode = RESP_IN_ORDER;
    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].qos_mode_type = QOS_MODE_DISABLE;
    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].is_active =
      SLAVE_AGENT_ACTIVE ? UVM_ACTIVE : UVM_PASSIVE;
    axi4_env_cfg_h.axi4_slave_agent_cfg_h[s].has_coverage = 1;
  end
endfunction
